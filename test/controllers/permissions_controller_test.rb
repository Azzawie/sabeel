...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference("Permission.count") do
      post permissions_url, params: { permission: { action_name: @permission.action_name, note: @permission.note, resource_name: @permission.resource_name } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { action_name: @permission.action_name, note: @permission.note, resource_name: @permission.resource_name } }
